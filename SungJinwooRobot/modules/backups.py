...
import SungJinwooRobot.modules.sql.notes_sql as sql
from SungJinwooRobot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER
from SungJinwooRobot.__main__ import DATA_IMPORT
...
# from SungJinwooRobot.modules.rules import get_rules
import SungJinwooRobot.modules.sql.rules_sql as rulessql

# from SungJinwooRobot.modules.sql import warns_sql as warnssql
import SungJinwooRobot.modules.sql.blacklist_sql as blacklistsql
from SungJinwooRobot.modules.sql import disable_sql as disabledsql

# from SungJinwooRobot.modules.sql import cust_filters_sql as filtersql
# import SungJinwooRobot.modules.sql.welcome_sql as welcsql
import SungJinwooRobot.modules.sql.locks_sql as locksql
from SungJinwooRobot.modules.connection import connected
...
def export_data(update, context):
    ...
    f = open("Mai Sakurajima {}.backup".format(chat_id), "w")
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Mai Sakurajima {}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Mai Sakurajima -Backup` was specially made for notes."
        .format(chat.title, chat_id, tgl),
        timeout=360,
        reply_to_message_id=msg.message_id,
        parse_mode=ParseMode.MARKDOWN,
    )
    os.remove("Mai Sakurajima {}.backup".format(chat_id))  # Cleaning file
