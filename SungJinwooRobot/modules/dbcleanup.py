...
import SungJinwooRobot.modules.sql.global_bans_sql as gban_sql
import SungJinwooRobot.modules.sql.users_sql as user_sql
from SungJinwooRobot import DEV_USERS, OWNER_ID, dispatcher
